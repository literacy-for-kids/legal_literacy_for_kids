---
sidebar_position: 1
sidebar_label: "Week 1: Why Groups Need Rules"
title: "Week 1: Why Groups Need Rules"
description: "Students discover why groups need rules and how rules help people share space fairly."
---
...
- optional [Rule Inventory Worksheet](./resources/rule-inventory-worksheet.md)

## Quick 20-Minute Version

1. Ask, "What would happen if recess had no rules?"
2. Find 3 real rules and ask what problem each one solves.
...
1. **Explain why rules exist:** "Why does a group need rules?"
2. **Name a real example:** "Tell me one rule you followed today."
3. **Predict a problem:** "What would happen if nobody took turns in a game?"
