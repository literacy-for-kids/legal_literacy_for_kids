...
Use the [Case Notes Template](./resources/case-notes-template.md) if you want a printable version.
...
- **Environmental literacy** - commons, treaties, shared resources, and enforcement problems
