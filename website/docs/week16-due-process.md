---
sidebar_position: 16
sidebar_label: "Week 16: Everyone Gets a Fair Chance"
title: "Week 16: Everyone Gets a Fair Chance"
description: "Students learn the checklist for a fair hearing before someone is punished or blamed."
---
...
- paper
- pencil
- optional [Listening Protocol Template](./resources/listening-protocol-template.md)
- learner's charter
- **Case Notes**

## Quick 20-Minute Version

1. Compare a rushed shortcut with a fair process.
2. Build the 6-step Fair Chance Checklist.
...
Use the [Listening Protocol Template](./resources/listening-protocol-template.md) as a formal support, but keep the learner's child-facing title if needed:
...
:::tip Learning Moment
Multi-step processes like due process need repeat practice to remember in order. Try saying the steps from memory, check what you missed, and practice that step again later.
...
1. **Name the idea:** "What does a fair chance mean?"
2. **Use the checklist:** "Can you name the main steps?"
3. **Apply it:** "What would a fair process look like in one simple story?"
