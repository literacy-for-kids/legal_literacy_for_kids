---
sidebar_position: 13
sidebar_label: "Week 13: My Group Agreement (Micro-Charter)"
title: "Week 13: My Group Agreement (Micro-Charter)"
description: "Students create a real group agreement with rules, protections, a disagreement process, and a way to change the rules later."
---
...
- paper
- pencil
- optional [Micro-Charter Template](./resources/micro-charter-template.md)
- **Case Notes**

## Quick 20-Minute Version

1. Pick a real, safe, opt-in group.
2. Fill in 5 boxes: what this group is for, important rules, protected promises, disagreement process, how to change rules.
3. Read it aloud and fix one fuzzy part.
...
- If useful, print the [Micro-Charter Template](./resources/micro-charter-template.md).
:::
...
1. **Explain the charter's purpose:** "What is this group agreement for?"
2. **Point to each section:** "Where are the rules, protections, disagreement process, and update process?"
3. **Show ownership:** "Could your group really use this?"
